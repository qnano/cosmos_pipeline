classdef guiExperimentPoolingMultiplexRNAWrapperDarkROI < analyzeMultiplexRNAWrapper
   properties

   end
   methods
        function obj = guiExperimentPoolingMultiplexRNAWrapperDarkROI(varargin)
