...
%             uimenu(c,'Label','Export Data','Callback',@obj.exportRastergramData);
            ...
            title(sprintf('spot ID = %d, meanTime2FirstEvent = %0.2g, meanDwellTime = %0.2g\n, Analyzed %d Spots',obj.handels.selectedSpotIndex,obj.meanTime2FirstEvent,obj.meanDwellTime,sum(obj.spotsIncluded)),'Parent', obj.handels.rastergramPlot)
        ...
        function [meanDwellTimeBS,meanTime2FirstEventBS] = bootStrapRastergram(obj,N,sortState)
            ...
            for i=1:N
                ...
                title(sprintf('spot ID = %d, meanTime2FirstEvent = %0.2g \\pm %0.2g, meanDwellTime = %0.2g \\pm%0.2g, At %d of %d,\n Analyzed %d Spots, Bootstrapped %d Spots',obj.handels.selectedSpotIndex,mean(meanTime2FirstEventBS(1:i)),...
                std(meanTime2FirstEventBS(1:i)),mean(meanDwellTimeBS(1:i)),std(meanDwellTimeBS(1:i)),i,N,NspotsAn,NspotsBo),'Parent', obj.handels.rastergramPlot)
        ...
        function draghline(obj,src,ev)
            ...
            if ~isempty(obj.seq) && any(obj.sortMap>0)
                 ...
                 title(sprintf('spot ID = %d, meanTime2FirstEvent = %0.2g, meanDwellTime = %0.2g, Analyzed %d Spots',obj.handels.selectedSpotIndex,obj.meanTime2FirstEvent,obj.meanDwellTime,sum(obj.spotsIncluded)),'Parent', obj.handels.rastergramPlot)
            end       
        end
