classdef analyzeMultiplexRNAWrapper < handle
   properties
        analyseDynamics
        objects
        addedvars=false;
   ...
   methods
       ...
       function whoAmI(obj,~,~)
        ...
        function obj = analyzeMultiplexRNAWrapper(h,gdlObj,gaObj,gdcObj,sdmwObj,MultiplexRNA,intergrationTime,colocalized)
            ...
            for i=1:MultiplexRNA
                obj.analyseDynamics{i} = guiAnalyzeDynamics(htabgroup,obj.objects.gdlObj,obj.objects.gaObj,obj.objects.gdcObj,obj.objects.sdmwObj.spotDetectorObjects{i},intergrationTime,obj.handels.parentMenu,['RNA ' num2str(i)],MultiplexRNA+1,i,colocalized);
